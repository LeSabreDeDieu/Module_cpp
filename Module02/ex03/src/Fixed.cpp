...
void Fixed::setRawBits( int const raw ) { this->_entier = raw; }

float Fixed::toFloat() const { return (float)(_entier) / (1 << _RAW_BITS); }
int Fixed::toInt() const { return _entier >> _RAW_BITS; }
